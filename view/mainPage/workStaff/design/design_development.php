...
<body>
    ...
    <div class="container-md my-2 py-2">
        ...
        <div class="d-flex justify-content-between" >
            <h2 class="text-title m-0" >Design Department</h2>
        ...
        <table class="table table-bordered text_table my-3">
            ...
            <tbody id="table_body">
                <?php
                    $array = $sqlMain->getData('design_development');
                    if(sizeof($array)):
                ...
                <tr data-id="<?php echo $row['id']; ?>">
                    ...
                    <td class="project_name"><?php echo $row['project_name'];?></td>
                    <td class="project_description"><?php echo $row['project_description'];?></td>
                    <td class="start_date"><?php echo $row['start_date'];?></td>
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center flex-row flex-wrap">
                            ...
                            <button data-update="<?php echo $row['id']; ?>" type="button" class="border rounded rounded-start-0 update-btn">
                                <i class="fa fa-pen"></i>
                            </button>
                        </div>
                    </td>
                ...
                <div class="modal-content">
                    <form id="add_update_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-3" >
                                <label class="text-custom" for="project_name">Project Name</label>
                                <input type="text" class="form-control shadow-none text-custom" name="project_name" id="project_name">
                                <span id="err_project_name" class="text text-danger text-custom"></span>
                            </div>
                            <div class="my-3" >
                                <label class="text-custom" for="project_description">Project Description</label>
                                <textarea class="form-control shadow-none text-custom" name="project_description" id="project_description"></textarea>
                                <span id="err_project_description" class="text text-danger text-custom"></span>
                            </div>
                            <div class="my-3" >
                                <label class="text-custom" for="start_data">Start Date</label>
                                <input type="date" class="form-control shadow-none text-custom" name="start_date" id="start_data">
                                <span id="err_start_data" class="text text-danger text-custom"></span>
                            </div>
                            <div class="my-3" >
                                <label class="text-custom" for="end_data">End Date</label>
                                <input type="date" class="form-control shadow-none text-custom" name="end_date" id="end_data">
                                <span id="err_end_data" class="text text-danger text-custom"></span>
                            </div>
                            <div class="my-3" >
