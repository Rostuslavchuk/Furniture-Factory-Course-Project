document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function modalUpdateAddErrors() {
        ...
        document.getElementById('err_project_name').textContent = '';
        document.getElementById('err_project_description').textContent = '';
        document.getElementById('err_start_data').textContent = '';
        document.getElementById('err_end_data').textContent = '';
    ...
    function errorLog(code) {
        switch (code) {
            ...
            case 2:
                return 'err_position';
            case 3:
                return 'err_project_name'
            case 4:
                return 'err_project_description';
            case 5:
                return 'err_start_data';
            case 6:
                return 'err_end_data';
            case 7:
                return 'err_salary';
    ...
    function add(data) {
        ...
        <tr data-id="${data.id}">
            ...
            <td class="project_description" >${data.project_description}</td>
    ...
    function update(data) {
        ...
        if (updateHtml) {
            ...
            updateHtml.querySelector('.project_name').textContent = data.project_name;
            updateHtml.querySelector('.project_description').textContent = data.project_description;
            updateHtml.querySelector('.start_date').textContent = data.start_date;
            updateHtml.querySelector('.end_date').textContent = data.end_date;
            ...
            if (imgElement) {
                ...
                imgElement.src = `./dd/DD${id_update}.jpg?timestamp=${timestamp}`;
            }
        }
    }
            ...
            btn.onclick = async (e) => {
                ...
                if(response.status){
                    ...
                    if(getData){
                        ...
                        addUpdateModalParams.form.elements['project_name'].value = getData.querySelector('.project_name').textContent;
                        addUpdateModalParams.form.elements['project_description'].value = getData.querySelector('.project_description').textContent;
                        addUpdateModalParams.form.elements['start_date'].value = getData.querySelector('.start_date').textContent;
                        addUpdateModalParams.form.elements['end_date'].value = getData.querySelector('.end_date').textContent;
