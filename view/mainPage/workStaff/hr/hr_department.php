...
<div class="container-md my-2 py-2">
    ...
    <div class="d-flex justify-content-between" >
        <h2 class="text-title m-0" >Hr Department</h2>
    ...
    <table class="table table-bordered text_table my-3">
        ...
        <tbody id="table_body">
        <?php
        $array = $sqlMain->getData('hr_department');
        if(sizeof($array)):
            foreach ($array as $row):
                ...
                <tr data-id="<?php echo $row['id']; ?>">
                    ...
                    <td class="hire_date"><?php echo $row['hire_date'];?></td>
                    <td class="department"><?php echo $row['department'];?></td>
                    <td class="performance_review"><?php echo $row['performance_review'];?></td>
                    <td class="salary"><?php echo $row['salary'];?></td>
                    <td>
                        <img data-img="<?php echo $row['id']; ?>" src="../../workStaff/hr/hr/HR<?php echo $row['id']; ?>.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="">
                    </td>
                    <td>
            ...
            <div class="modal-content">
                <form id="add_update_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="my-3" >
                            <label class="text-custom" for="hire_date">Hire Date</label>
                            <input type="date" class="form-control shadow-none text-custom" name="hire_date" id="hire_date">
                            <span id="err_hire_date" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="department">Department</label>
                            <input type="text" class="form-control shadow-none text-custom" name="department" id="department" />
                            <span id="err_department" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="performance_review">Performance Review</label>
                            <textarea class="form-control shadow-none text-custom" name="performance_review" id="performance_review"></textarea>
                            <span id="err_performance_review" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
