document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function modalUpdateAddErrors() {
        ...
        document.getElementById('err_hire_date').textContent = '';
        document.getElementById('err_department').textContent = '';
        document.getElementById('err_performance_review').textContent = '';
    ...
    function errorLog(code) {
        switch (code) {
            ...
            case 2:
                return 'err_position';
            case 3:
                return 'err_hire_date'
            case 4:
                return 'err_department';
            case 5:
                return 'err_performance_review';
            case 6:
                return 'err_salary';
            case 7:
    ...
    function add(data) {
        ...
        <tr data-id="${data.id}">
            ...
            <td class="hire_date" >${data.hire_date}</td>
    ...
    function update(data) {
        ...
        if (updateHtml) {
            ...
            updateHtml.querySelector('.hire_date').textContent = data.hire_date;
            updateHtml.querySelector('.department').textContent = data.department;
            updateHtml.querySelector('.performance_review').textContent = data.performance_review;
            ...
            if (imgElement) {
                ...
                imgElement.src = `./hr/HR${id_update}.jpg?timestamp=${timestamp}`;
            }
        }
    }
            ...
            btn.onclick = async (e) => {
                ...
                if(response.status) {
                    ...
                    if (getData) {
                        ...
                        addUpdateModalParams.form.elements['hire_date'].value = getData.querySelector('.hire_date').textContent;
                        addUpdateModalParams.form.elements['department'].value = getData.querySelector('.department').textContent;
                        addUpdateModalParams.form.elements['performance_review'].value = getData.querySelector('.performance_review').textContent;
