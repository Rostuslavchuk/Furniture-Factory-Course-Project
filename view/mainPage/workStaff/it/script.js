document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function setEmpty(bodyTable) {
        if (bodyTable.querySelectorAll('tr').length === 0) {
            bodyTable.insertAdjacentHTML('beforeend', `
                <tr id="empty">
                    <td colspan="10" class="text-center text-title">Table is Empty</td>
                </tr>
            `);
        } else {
    ...
    function add(data) {
        ...
        <tr data-id="${data.id}">
            ...
            <td class="image_employee">
                <img src="./it/IT${data.id}.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="Emploee Image">
            </td>
            <td>
    ...
    async function data(data) {
        const url = "http://localhost:63342/furniture_factory/view/mainPage/workStaff/it/validate.php";
