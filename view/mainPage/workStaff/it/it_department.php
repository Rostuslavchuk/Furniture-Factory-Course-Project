...
<div class="container-md my-2 py-2">
    ...
    <div class="d-flex justify-content-between" >
        <h2 class="text-title" >It Department</h2>
    ...
    <table class="table table-bordered text_table my-3">
        ...
        <tbody id="table_body">
        <?php
        $array = $sqlMain->getData('it_department');
        if(sizeof($array)):
            foreach ($array as $row):
                ...
                <tr data-id="<?php echo $row['id']; ?>">
                    ...
                    <td class="system_managed"><?php echo $row['system_managed'];?></td>
                    <td class="issue_reported"><?php echo $row['issue_reported'];?></td>
                    <td class="resolution"><?php echo $row['resolution'];?></td>
                    <td class="date_reported"><?php echo $row['date_reported'];?></td>
            ...
            <div class="modal-content">
                <form id="add_update_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="my-3" >
                            <label class="text-custom" for="system_managed">System Managed</label>
                            <input type="text" class="form-control shadow-none text-custom" name="system_managed" id="system_managed">
                            <span id="err_system_managed" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="issue_reported">Issue Reported</label>
                            <textarea class="form-control shadow-none text-custom" name="issue_reported" id="issue_reported"></textarea>
                            <span id="err_issue_reported" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="resolution">Resolution</label>
                            <textarea class="form-control shadow-none text-custom" name="resolution" id="resolution"></textarea>
                            <span id="err_resolution" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="date_reported">Date Reported</label>
                            <input type="date" class="form-control shadow-none text-custom" name="date_reported" id="date_reported" />
                            <span id="err_date_reported" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="date_resolved">Date Resolved</label>
                            <input type="date" class="form-control shadow-none text-custom" name="date_resolved" id="date_resolved" />
                            <span id="err_date_resolved" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
