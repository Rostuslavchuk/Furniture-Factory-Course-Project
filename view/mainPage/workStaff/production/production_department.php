...
<div class="container-md my-2 py-2">
    ...
    <div class="d-flex justify-content-between" >
        <h2 class="text-title" >Production Department</h2>
    ...
    <table class="table table-bordered text_table my-3">
        ...
        <tbody id="table_body">
        <?php
        $array = $sqlMain->getData('production');
        if(sizeof($array)):
            foreach ($array as $row):
                ...
                <tr data-id="<?php echo $row['id']; ?>">
                    ...
                    <td class="task_description"><?php echo $row['task_description'];?></td>
                    <td class="shift_start"><?php echo $row['shift_start'];?></td>
                    <td class="shift_end"><?php echo $row['shift_end'];?></td>
                    <td class="salary"><?php echo $row['salary'];?></td>
                    <td>
                        <img data-img="<?php echo $row['id']; ?>" src="../../workStaff/production/production/P<?php echo $row['id']; ?>.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="">
                    </td>
                    <td>
            ...
            <div class="modal-content">
                <form id="add_update_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="my-3" >
                            <label class="text-custom" for="section">Section</label>
                            <input type="text" class="form-control shadow-none text-custom" name="section" id="section">
                            <span id="err_section" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="task_description">Task Description</label>
                            <textarea class="form-control shadow-none text-custom" name="task_description" id="task_description"></textarea>
                            <span id="err_task_description" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="shift_start">Shift Start</label>
                            <input type="time" class="form-control shadow-none text-custom" name="shift_start" id="shift_start" />
                            <span id="err_shift_start" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
                            <label class="text-custom" for="shift_end">Shift End</label>
                            <input type="time" class="form-control shadow-none text-custom" name="shift_end" id="shift_end" />
                            <span id="err_shift_end" class="text text-danger text-custom"></span>
                        </div>
                        <div class="my-3" >
