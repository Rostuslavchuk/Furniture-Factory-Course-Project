document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function add(data) {
        ...
        <tr data-id="${data.id}">
            ...
            <td class="image_employee">
                <img src="./quality_control/QC${data.id}.jpg" style="width: 100%; height: 100%; object-fit: cover;" alt="Emploee Image">
            </td>
            <td>
    ...
    async function data(data) {
        const url = "https://funrniturefactory.userbliss.org/view/mainPage/workStaff/quality_control/validate.php";
